...
public class Calculator {
    ...
    public static int getNumber() {
        ...
        for (int i = 0; i < charsFromInputNumber.length; i++) {
            if (charsFromInputNumber[i] != '0' &&
                    charsFromInputNumber[i] != '1' &&
                    charsFromInputNumber[i] != '2' &&
                    charsFromInputNumber[i] != '3' &&
                    charsFromInputNumber[i] != '4' &&
                    charsFromInputNumber[i] != '5' &&
                    charsFromInputNumber[i] != '6' &&
                    charsFromInputNumber[i] != '7' &&
                    charsFromInputNumber[i] != '8' &&
